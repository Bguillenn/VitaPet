...
['Banho(custo / lucro)',1000, 3000],
['Desparasitação(custo / lucro)', 1200, 2000],
['Operações(custo / lucro)', 3000, 6000],
['Medicamentos(custo / lucro)', 1000, 2500],
['Outros(custo / lucro)', 2000, 4000]
    ]);

    // set chart title
    chart.title('Veterinária San Juan');
