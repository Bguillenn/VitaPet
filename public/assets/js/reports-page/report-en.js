...
['Bathrooms(cost / profit)',1000, 3000],
['Deworming(cost / profit)', 1200, 2000],
['Operations(cost / profit)', 3000, 6000],
['Medicines(cost / profit)', 1000, 2500],
['Others(cost / profit)', 2000, 4000]
    ]);

    // set chart title
    chart.title('Veterinary San Juan');
